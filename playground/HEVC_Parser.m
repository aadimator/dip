...
% Data format: 	       16    a     870.6600   34.2720   35.0217   36.1228   33.7482
% Data is 2 lines ahead of "summary_line"
summary_cell = textscan(fid,'%f %s %f %f',1,'delimiter', ' ', 'MultipleDelimsAsOne', 1, 'headerlines',summary_line + 1);
